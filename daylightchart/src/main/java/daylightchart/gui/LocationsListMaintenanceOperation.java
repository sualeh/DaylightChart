...
enum LocationsListMaintenanceOperation
{
  ...
  private LocationsListMaintenanceOperation(final String text,
      ...
      final ActionEvent e)
      {
        ...
        Location editedLocation = LocationDialog
          .showLocationDialog(locationsList,
                              LocationsListMaintenanceOperation.this);
        if (editedLocation != null)
        {
          switch (LocationsListMaintenanceOperation.this)
          {
            case add:
