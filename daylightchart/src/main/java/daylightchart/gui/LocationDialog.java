 ...
 * Copyright (c) 2007, Pradnya Devare.
 * 
  ...
  implements ActionListener
{
  ...
  private Vector<Country> vctCountries = null;
  ...
  public LocationDialog(DaylightChartGui frame)
  {
    ...
    vctCountries = new Vector<Country>();
  ...
  private void populateCountries()
  {
    ...
    vctCountries.addAll(hsCountries);
    Collections.sort(vctCountries);
    cbCountries = new JComboBox(vctCountries);
  ...
  public void actionPerformed(ActionEvent actevt)
  {
    ...
    // if (actevt.getSource() == (JButton)btnCalcTZ)
    {
