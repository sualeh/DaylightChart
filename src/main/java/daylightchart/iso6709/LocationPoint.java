...
public final class LocationPoint
  implements Serializable, Comparable<LocationPoint>
{
   ...
   * @param longitude
   */
  public LocationPoint(final Latitude latitude, final Longitude longitude)
  {
   ...
   */
  public int compareTo(final LocationPoint coordinates)
  {
